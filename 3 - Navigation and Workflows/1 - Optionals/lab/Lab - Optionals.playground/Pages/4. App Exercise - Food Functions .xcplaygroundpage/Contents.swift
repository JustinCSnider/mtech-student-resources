...
func checkMealLog(mealLog: String) -> [String: Any] {
    if let unwrappedMealLog = UserDefaults.standard.dictionary(forKey: mealLog) {
        return unwrappedMealLog
    }
    return [:]
}
