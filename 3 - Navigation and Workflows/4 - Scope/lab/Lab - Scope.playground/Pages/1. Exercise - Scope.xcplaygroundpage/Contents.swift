...
print("Because it's outside of the scope of where the variable foo was created")
/*:
...
print("Because the x variables scope is global rather than just being local to the for loop.")
/*:
...
greeting(greeting: nil, name: "Elmo")
/*:
