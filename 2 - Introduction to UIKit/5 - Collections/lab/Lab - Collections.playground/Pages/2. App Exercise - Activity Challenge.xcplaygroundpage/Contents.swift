...
var walkingChallenges: [String] = ["Walk 10 feet", "Walk 20 feet"]
var runningChallenges: [String] = ["Run 1 mile", "Run 2 miles"]
/*:
...
if commitedChallenges.isEmpty {
    ...
    print("The challenge you have chosen is \(commitedChallenges)")
} else {
