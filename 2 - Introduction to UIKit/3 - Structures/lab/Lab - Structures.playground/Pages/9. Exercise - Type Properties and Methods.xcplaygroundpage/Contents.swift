...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: User = User(userName: "Justin", email: "jcsnider100@gmail.com", age: 19)
...
var me = User(userName: "dude", email: "dude", age: 19)
print(User.currentUser)
User.currentUser.logIn(user: me)
print(User.currentUser)
