...
var Justin = User(name: "Justin", age: 19, height: 5.6, weight: 130.5, activityLevel: 4)
print("My name is \(Justin.name) and I am \(Justin.age) years old, I am \(Justin.height) feet tall, I weigh \(Justin.weight) lbs and my activity level is around a \(Justin.activityLevel).")
/*:
...
var myHeight = Distance(feet: 5.6)
print(myHeight.meters)
