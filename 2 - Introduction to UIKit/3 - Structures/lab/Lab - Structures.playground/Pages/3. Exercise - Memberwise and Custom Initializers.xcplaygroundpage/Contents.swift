...
var favoriteBook = Book(title: "Rich Dad, Poor Dad", author: "Robert Kiyosaki", pages: 218, price: 30.50)

print("My favorite book's title is \(favoriteBook.title) by \(favoriteBook.author) with \(favoriteBook.pages) pages at the small price of $\(favoriteBook.price).")
/*:
...
var myHeight = Height(heightInInches: 67.2)
